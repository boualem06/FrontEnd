...
function ModifierUser({ values, setValues }) {
      ...
      <div className="mt-4  grid grid-cols-2 space-x-10">
        ...
        <div className="self-center flex justify-between ">
          ...
          <div className="space-x-2">
            ...
            {values.deleted &&  <input type="checkbox" id="deleted" onChange={handledeleted}  />}
            {!values.deleted &&  <input type="checkbox" id="deleted" onChange={handledeleted} checked />}
